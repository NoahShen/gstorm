...
import models.ClassAutoTimestamp
import models.ClassAutoTimestampByAnno
import models.ClassNoTimestamp
 ...
 */
class GstormAutoTimestampTests {
    ...
    void setUp() {
        ...
        gstorm.stormify(ClassAutoTimestamp, true)
        gstorm.stormify(ClassAutoTimestampByAnno, true)
        gstorm.stormify(ClassNoTimestamp, true)
    }
